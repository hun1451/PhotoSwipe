...
Sass를 사용하는 경우 [_main-settings.scss](https://github.com/hun1451/PhotoSwipe/blob/master/src/css/_main-settings.scss)에서 전환 기간 변수를 변경하기 만하면됩니다.
...
[FAQ 섹션](faq.md#custom-pid-in-url)에서 맞춤 PID를 구현하는 방법에 대해 자세히 알아보십시오.
...
전체 뷰포트를 차지하기 위해 PhotoSwipe를 확장해야하는지 여부를 조정합니다. `false` 인 경우 PhotoSwipe 요소는 템플릿의 위치 지정된 부모 크기를 사용합니다. 자세한 내용은 [FAQ] (faq.md # inline-gallery)를 참조하십시오.

...
PhotoSwipe를 분리 한 후에도 빠르게 작동하지 않으면 & ndash; [GitHub의 문제](https://github.com/hun1451/PhotoSwipe/issues)를 열고 [축소 된 테스트 케이스] (http://css-tricks.com/reduced-test-cases/) 링크를 제공하십시오. .
...
이 페이지를 개선 할 수있는 방법을 알고 있습니까? [Suggest an edit!](https://github.com/hun1451/PhotoSwipe/blob/master/website/documentation/responsive-images.md)